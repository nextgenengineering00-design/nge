    ...
    connectedCallback() {
      ...
      this.innerHTML = `${icons}
        <header class="site-header" id="top">
          <div class="header-utility"><div><span>รับเหมาก่อสร้าง นนทบุรี กรุงเทพฯ และปริมณฑล</span><span class="header-utility-links"><a href="/faq">ถาม–ตอบ</a><a href="/contact">นัดหมายปรึกษาฟรี</a></span></div></div>
          <div class="header-inner">
            ...
            <nav class="desktop-nav" aria-label="เมนูหลัก">
              <a data-nav="home" href="/">หน้าหลัก</a><a data-nav="about" href="/about">ประวัติบริษัท</a><a data-nav="services" href="/services">บริการ</a><a data-nav="why" href="/why-us">จุดเด่น</a><a data-nav="projects" href="/projects">ผลงาน</a><a data-nav="knowledge" href="/knowledge">ความรู้</a><a data-nav="reviews" href="/reviews">รีวิว</a><a data-nav="contact" href="/contact">ติดต่อเรา</a>
            </nav>
      ...
      this.innerHTML = `
        <footer class="site-footer">
          <div class="container footer-grid">
            ...
            <div class="footer-about"><span>NEXT GEN ENGINEERING</span><h2>คุยกันให้ชัด<br>ก่อนเริ่มทุกหน้างาน</h2><p>ดูแลงานสร้างบ้าน อาคาร ต่อเติม รีโนเวท และงานระบบในนนทบุรี กรุงเทพฯ และพื้นที่ใกล้เคียง</p><p class="legal-company">ดำเนินการภายใต้<br><b><a href="https://www.dataforthai.com/company/0103528028423/" target="_blank" rel="noopener noreferrer">ห้างหุ้นส่วนจำกัด รวมพลชัย เอ็นจิเนียริ่ง</a></b></p><a class="footer-profile-link" href="/about">รู้จักเรามากขึ้น</a></div>
            <div class="footer-links"><h3>เมนู</h3><a href="/about">ประวัติบริษัท</a><a href="/services">บริการทั้งหมด</a><a href="/why-us">มาตรฐานการทำงาน</a><a href="/projects">ผลงาน</a><a href="/knowledge">ความรู้ก่อสร้าง</a><a href="/reviews">รีวิวลูกค้า</a></div>
            <div class="footer-links"><h3>ช่วยเหลือ</h3><a href="/#booking">จองเวลาปรึกษา</a><a href="/faq">คำถามที่พบบ่อย</a><a href="/contact">ส่งข้อมูลติดต่อ</a><a href="/privacy">นโยบายความเป็นส่วนตัว</a><a class="js-facebook-link" href="/reviews">Facebook</a></div>
            <div class="footer-contact"><h3>ติดต่อทีมงาน</h3><a class="js-phone-link" href="/contact"><small>โทรศัพท์ 1</small><b class="js-phone-text">098-279-9145</b></a><a class="js-phone-secondary-link" href="/contact"><small>โทรศัพท์ 2</small><b class="js-phone-secondary-text">096-881-4033</b></a><a class="js-line-link" href="/contact"><small>LINE Official</small><b class="js-line-text">@522magc</b></a><p>รับงานนนทบุรี กรุงเทพฯ และพื้นที่ปริมณฑล</p></div>
          </div>
        ...
        <nav class="mobile-dock" aria-label="ติดต่อด่วนบนมือถือ"><a class="js-phone-link" href="/contact"><svg><use href="#i-phone"/></svg><span>โทรเลย</span></a><a class="js-line-link" href="/contact"><svg><use href="#i-line"/></svg><span>LINE</span></a><a href="/#booking"><svg><use href="#i-clock"/></svg><span>จองคิว</span></a></nav>
