        ...
        <header class="site-header" id="top">
          ...
          <div class="header-inner">
            ...
            <nav class="desktop-nav" aria-label="เมนูหลัก">
              <a data-nav="home" href="/">หน้าหลัก</a><a data-nav="about" href="/about">ประวัติบริษัท</a><a data-nav="services" href="/services">บริการ</a><a data-nav="projects" href="/projects">ผลงาน</a><a data-nav="knowledge" href="/knowledge">ความรู้</a><a data-nav="contact" href="/contact">ติดต่อเรา</a>
            </nav>
            ...
            <button class="menu-toggle notranslate" type="button" aria-label="เปิดเมนู" aria-controls="mobilePanel" aria-expanded="false"><span class="menu-toggle-lines" aria-hidden="true"><i></i><i></i><i></i></span><span class="menu-toggle-label">MENU</span></button>
          </div>
          <div class="mobile-panel" id="mobilePanel" aria-hidden="true" hidden><nav aria-label="เมนูมือถือ"><a data-nav="home" href="/">หน้าหลัก</a><a data-nav="about" href="/about">ประวัติบริษัท</a><a data-nav="services" href="/services">บริการ</a><a data-nav="projects" href="/projects">ผลงาน</a><a data-nav="knowledge" href="/knowledge">ความรู้</a><a data-nav="faq" href="/faq">คำถามที่พบบ่อย</a><a data-nav="contact" href="/contact">ติดต่อเรา</a></nav><div class="mobile-panel-actions"><a class="btn btn-dark js-phone-link" href="/contact">โทร <span class="js-phone-text">098-279-9145</span></a><a class="btn btn-dark js-phone-secondary-link" href="/contact">โทร <span class="js-phone-secondary-text">096-881-4033</span></a><a class="btn btn-line js-line-link" href="/contact">LINE: <span class="js-line-text">@522magc</span></a></div></div>
        </header>`;
      ...
      this.innerHTML = `
        <footer class="site-footer">
          <div class="container footer-grid">
            ...
            <div class="footer-links"><h3>เมนู</h3><a href="/about">ประวัติบริษัท</a><a href="/services">บริการทั้งหมด</a><a href="/projects">ผลงาน</a><a href="/knowledge">ความรู้ก่อสร้าง</a></div>
