...
export function LegacyPage({ file, project = false }: { file: string; project?: boolean }) {
  ...
  return <div className={page.bodyClass} data-legacy-page={page.page}>
    ...
    <LegacyRuntimeScripts sources={project
      ? ["/legacy/site-config.js","/legacy/project-detail.js","/legacy/language-switcher.js?v=20260925-3"]
      : ["/legacy/site-config.js?v=20260925-1","/legacy/site-shell.js?v=20260925-2","/legacy/app.js?v=20260925-1","/legacy/language-switcher.js?v=20260925-3"]} />
  </div>;
}
