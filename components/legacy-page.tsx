...
export function LegacyPage({ file, project = false }: { file: string; project?: boolean }) {
  ...
  return <div className={page.bodyClass} data-legacy-page={page.page}>
    ...
    <link rel="stylesheet" href="/legacy/styles.min.css?v=20260921-5" />
    {!project && <link rel="stylesheet" href="/legacy/service-seo.css?v=20260920" />}
    ...
    <LegacyRuntimeScripts sources={project
      ...
      : ["/legacy/site-config.js?v=20260921-3","/legacy/site-shell.js?v=20260921-4","/legacy/app.js?v=20260921-3"]} />
  </div>;
}
