...
export function Footer() {
  return <footer className="site-footer"><div className="container footer-grid">
    ...
    <div><b>สำรวจต่อ</b><Link href="/">รับเหมาก่อสร้างครบวงจร</Link><Link href="/services">บริการ</Link><Link href="/projects">ผลงาน</Link><Link href="/knowledge">คลังความรู้</Link></div>
