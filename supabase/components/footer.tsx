...
export function Footer() {
  return <footer className="site-footer"><div className="container footer-grid">
    <div><span className="brand-mark">NGE</span><h2>สร้างให้ชัด คุมให้เป็น ส่งมอบให้จริง</h2><p>รับเหมาก่อสร้าง รีโนเวท งานโยธา และบริหารโครงการใน{site.area}</p></div>
